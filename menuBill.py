...
class CrudClients(ICrud):
    ...
    def update(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Actualizar datos de Clientes")
    ...
    def delete(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Borrar datos de Clientes")
        dni = input("Ingrese el dni que desea buscar: ")
        dele = functions()
    ...
    def consult(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Buscar datos de Clientes")
        dni = input("Ingrese el dni que desea buscar: ")
        consu = functions()
...
class CrudProducts(ICrud):
    def create(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Crear producto")
        description_product = input("Ingresar descripción del producto: ")
        price_product = input("Ingresar precio del producto: ")
        stock_product = input("Ingresar stock del producto. ")
    ...
    def update(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "ACtualizar producto")
        id_product = input("Ingrese el id del producto que desea buscar: ").replace(" ","")
    ...
    def delete(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Borrar producto")
        descri_product = input("Ingrese la descripción del producto que desea eliminar: ").replace(" ", "")
    ...
    def consult(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Consultar producto")
        consult_product = input("Ingrese el ID del producto que desea buscar")
...
class CrudSales(ICrud):
    ...
    def update(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Actualizar factura")
        number_invoice = input("Ingrese el número de la factura")
    ...
    def delete(self):
        borrarPantalla()
        print(red_color + "*" * 50 + reset_color)
        print(cyan_color + "Borrar Factura")
        number_invoice = input("Ingrese el número de la factura que desea eliminar")
